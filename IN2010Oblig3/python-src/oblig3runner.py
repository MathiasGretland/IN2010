...
ALGS1 = [insertion.sort, quick.sort, selection.sort, radix.sort]
#ALGS1 = [quick.sort, radix.sort]
# Put the sorting algorithms under test for part 2 here
ALGS2 = [insertion.sort, quick.sort, selection.sort, radix.sort]
#ALGS2 = [quick.sort, radix.sort]
